            ...
            <div className="row flex-nowrap">
                ...
                <div className="col py-3">
                    <form onSubmit={sendData}>
                        < Input id={username} title={user name} type={text} name={username} handelData={handelData} />

                        < Input id={email} title={user name} type={text} name={username} handelData={handelData} />

                        < Input id={username} title={user name} type={text} name={username} handelData={handelData} />

                        <div className="mb-3">
                            <label htmlFor="email" className="form-label">user email</label>
                            <input type="email" name='email' className="form-control" id="email" onChange={handelData}/>
                        </div>
