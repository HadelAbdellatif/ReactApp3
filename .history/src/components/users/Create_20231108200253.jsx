            ...
            <div className="row flex-nowrap">
                ...
                <div className="col py-3">
                    <form onSubmit={sendData}>
                        ...
                        < Input id={'name'} title={'user name'} type={'text'} name={'name'} handelData={handelData} />

                        < Input id={'email'} title={'user email'} type={'email'} name={'email'} handelData={handelData} />

                        < Input id={'password'} title={'user password'} type={'password'} name={'password'} customClass="bg-danger" handelData={handelData} />
