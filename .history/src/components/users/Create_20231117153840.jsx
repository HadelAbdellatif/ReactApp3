    ...
    return (
        <div className="container-fluid">
            <div className="row flex-nowrap">
                ...
                <div className="col phttp://localhost:5173/y-3">

                    {errorBack && <p className='text text-danger fs-3'>{errorBack}</p>}

                    <form onSubmit={sendData}>
                        <Input errors={errors} id={'name'} title={'user name'} type={'text'} name={'name'} handelData={handelData} />

                        <Input errors={errors} id={'email'} title={'user email'} type={'email'} name={'email'} handelData={handelData} />

                        <Input errors={errors} id={'password'} title={'user password'} type={'password'} name={'password'} customClass="bg-danger" handelData={handelData} />
